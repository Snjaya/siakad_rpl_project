    ...
    <div class="py-12 bg-slate-50 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-xl border border-gray-100">
                ...
                {{-- HEADER TOOLS: Search, Print, Add --}}
                <div class="p-6 border-b border-gray-100 bg-white">
                    <form method="GET" action="{{ route('tu.teachers.index') }}"
                        ...
                        <div class="w-full md:w-auto flex flex-col md:flex-row gap-4 items-center">
                            <div class="text-gray-500 text-sm font-medium whitespace-nowrap">
                                Total Guru: <span
                                    class="text-emerald-600 font-bold text-lg">{{ $teachers->total() }}</span>
                            </div>
                        ...
                        <div class="flex flex-row gap-2 w-full md:w-auto">
                            {{-- TOMBOL CETAK (NEW) --}}
                            <a href="{{ route('tu.teachers.print') }}" target="_blank"
                                class="flex-1 md:flex-none bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg shadow-sm hover:shadow transition flex items-center justify-center gap-2">
                            ...
                            <a href="{{ route('tu.teachers.create') }}"
                                class="flex-1 md:flex-none bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-2 px-4 rounded-lg shadow-sm hover:shadow transition flex items-center justify-center gap-2 whitespace-nowrap">
                                ...
                                <tr class="hover:bg-emerald-50/30 transition duration-150 group">
                                    ...
                                    <td class="p-4">
                                        <div class="flex flex-col gap-1.5">
                                            <div class="flex items-center gap-2 text-gray-600">
                                                ...
                                                <span class="text-xs">{{ $teacher->user->email ?? '-' }}</span>
                                            </div>
                                            <div class="flex items-center gap-2 text-gray-600">
                                    ...
                                    <td class="p-4">
                                        @if ($teacher->tempat_lahir || $teacher->tanggal_lahir)
                                            ...
                                            <div class="text-[10px] text-gray-400 mt-1 truncate max-w-[180px]"
                                                title="{{ $teacher->alamat }}">
                                                <i class="fa-solid fa-location-dot mr-1"></i>
                                                {{ Str::limit($teacher->alamat, 25) }}
                                            </div>
                                        @else
