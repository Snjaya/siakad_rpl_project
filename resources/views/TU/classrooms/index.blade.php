            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-xl border border-gray-100">
                ...
                <div
                    ...
                    <div class="text-gray-500 text-sm font-medium w-full md:w-auto">
                        Total Kelas: <span class="text-emerald-600 font-bold text-lg">{{ $classrooms->count() }}</span>
                    </div>
                                ...
                                <tr>
                                    <td colspan="6" class="p-8 text-center text-gray-400 bg-slate-50">
                                        <div class="flex flex-col items-center justify-center">
                                            <i class="fa-solid fa-school text-4xl mb-3 text-gray-300"></i>
                        ...
                        <div class="bg-white p-5 rounded-xl shadow-sm border border-gray-100 relative overflow-hidden">
                            ...
                            <div class="flex justify-between items-start mb-3 pl-2">
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 font-medium">{{ $classroom->jurusan }}</p>
                                </div>
                            ...
                            <div class="space-y-2 mb-4 pl-2 text-sm text-gray-600 border-t border-gray-50 pt-3">
                                <div class="flex items-center gap-2">
                                    <i class="fa-solid fa-chalkboard-user text-gray-400 w-4"></i>
                                    <span
                                        class="{{ $classroom->teacher ? 'text-gray-700' : 'text-orange-500 italic' }}">
