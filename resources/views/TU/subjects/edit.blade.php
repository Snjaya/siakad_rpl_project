        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-xl border border-gray-100">
                <div class="p-8">
                    ...
                    <form action="{{ route('tu.subjects.update', $subject->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative w-32">
                                    <input type="number" name="kkm" value="{{ old('kkm', $subject->kkm) }}"
                                        min="0" max="100"
                                        class="w-full text-center rounded-lg border-gray-300 focus:border-emerald-500 focus:ring focus:ring-emerald-200 transition font-bold text-gray-700">
                                </div>
                                @error('kkm')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
