...
<body class="font-sans antialiased text-gray-900 bg-gray-100 min-h-screen flex items-center justify-center p-4">
    ...
    <div
        class="bg-white w-full max-w-5xl rounded-2xl shadow-2xl overflow-hidden flex flex-col lg:flex-row border border-gray-100">

        <div
            class="hidden lg:flex w-full lg:w-1/2 bg-white flex-col justify-between p-10 relative border-r border-gray-100">
            ...
            <div class="flex flex-col items-center justify-center text-center z-10 mt-8 mb-4">
                ...
                <div class="relative w-full max-w-xs">
                    <img src="{{ asset('login-illustration.png') }}" alt="Ilustrasi Sekolah"
                        class="w-full h-auto object-contain drop-shadow-lg rounded-lg">
                </div>
            </div>

            <div class="text-center">
                <p class="text-[10px] text-gray-400">Siakad SMK MARHAS Margahayu Bandung</p>
            </div>
        </div>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-4">
                        <x-input-label for="username" :value="__('Username / Email / NIP / NIS')"
                            class="text-gray-700 font-bold text-xs uppercase" />
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        @if (Route::has('password.request'))
                            <a class="text-sm text-blue-600 hover:text-blue-800 font-semibold hover:underline"
                    ...
                    <div class="flex items-center justify-end mt-4">
                        <button type="submit"
                            class="w-full bg-blue-700 hover:bg-blue-800 text-white font-bold py-3 px-4 rounded-lg shadow-md hover:shadow-lg transition duration-200">
                            {{ __('Masuk ke Portal') }}
                        </button>
                    </div>
                </form>
